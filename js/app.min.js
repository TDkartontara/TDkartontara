...
const popup_close_icon = document.querySelectorAll('.popup__close,._goto-block');
if (popup_close_icon) {
...
const fileBtn = document.querySelector('.file__button');
      ...
      if (formAction.length > 2) {
        ...
        fetch(formAction, {
          ...
          .then((response) => {
            ...
            document.querySelector('.popup_popup').classList.toggle('_active');
          })
          .catch((err) => {
            console.log(err);
...
//Наш блог
let advantage  = new Swiper('.advantage__row', {
	observer: true,
	observeParents: true,
	slidesPerView: 1,
    preloadImages:false,
